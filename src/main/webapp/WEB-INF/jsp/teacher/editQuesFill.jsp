...
<body>
	<section class="info-section">
		<form id="form" method="post">
			<table>
				<tr>
					<td class="text-title">问题：</td>
					<td class="text-content">
						<input type="hidden" id="quesFillId" name="quesFillId" value="${quesFill.quesFillId}">
						<input type="hidden" name="quesId" value="${quesId}">
						<input type="text" name="question" value="${quesFill.question}" 
				...
				<tr>
					<td class="text-title">答案：</td>
					<td class="text-content">
						<input type="text" name="answer" value="${quesFill.answer}" 
