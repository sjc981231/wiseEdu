			...
			<table>
				<tr>
					...
					<td class="text-content">
						...
						<input type="text" name="content" value="${lesson.content}" 
				...
				<tr>
					<td class="text-title">课程顺序：</td>
					<td class="text-content">
						<input type="text" name="sortNum" value="${lesson.sortNum}" 
							class="easyui-textbox theme-textbox-radius" data-options="required:true,validType:'length[1,20]'">
					</td>
				</tr>
				...
				<tr>
					<td class="text-title">课程状态：</td>
					<td class="text-content">
						<select name="status" class="easyui-combobox theme-textbox-radius">
							<option value="1" ${lesson.status==1? "selected":"" }>正常</option>
							<option value="0" ${lesson.status==0? "selected":"" }>禁用</option>
							<option value="2" ${lesson.status==2? "selected":"" }>已删除</option>
						</select>
					</td>
				</tr>
